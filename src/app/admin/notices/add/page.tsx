...
export default function AddNoticePage() {
  ...
  return (
    <div className="max-w-4xl space-y-5 pb-12 sm:space-y-6">
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="min-w-0">
          <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-2xl">Add New Notice</h2>
          <p className="text-sm text-slate-500 dark:text-slate-300">Create a new announcement or notice.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <Button type="submit" variant="primary" className="w-full h-12 text-base shadow-lg" disabled={isSubmitting || isUploading}>
              {isSubmitting ? (
                <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Saving Notice...</>
              ) : (
                "Save & Publish Notice"
              )}
            </Button>
