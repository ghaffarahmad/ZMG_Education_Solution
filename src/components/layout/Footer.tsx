      ...
      <Container>
        ...
        <div className="flex flex-col items-center gap-5 border-t border-slate-700/50 pt-6 md:flex-row md:justify-between md:gap-0">
          ...
          <div className="order-1 flex justify-center md:order-2 md:w-1/3">
            <a
              href="https://wa.me/923182402515"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center"
            >
              <div className="premium-border-spin inline-flex items-center gap-2.5 px-4 py-2 text-xs text-slate-300 transition-transform duration-300 hover:scale-105">
                <span className="relative z-10 flex items-center gap-1.5 tracking-wide">
                  Developed by <span className="premium-text-shimmer font-bold drop-shadow-sm">Sami</span>
                </span>
                
                <span className="relative z-10 flex h-6 w-6 items-center justify-center rounded-full bg-[#25D366]/20 text-[#25D366] shadow-[0_0_10px_rgba(37,211,102,0.4)]">
              ...
              <span className="mt-3 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.25em] text-slate-400 transition-colors group-hover:text-accent dark:group-hover:text-accent">
